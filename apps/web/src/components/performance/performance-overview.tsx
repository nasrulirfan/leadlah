  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-foreground">
                {metrics.actual.units} <span className="text-sm text-muted-foreground">/ {metrics.target.units}</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <Card>
        ...
        <div className="mt-4">
          <div className="flex items-center justify-between text-xs">
            <span className="text-muted-foreground">Target: RM {(metrics.target.income / 1000).toFixed(0)}k</span>
      ...
      <Card>
        ...
        <div className="mt-4">
          <Badge variant="warning" className="text-xs">
            {((metrics.actual.expenses / metrics.actual.commission) * 100).toFixed(1)}% of commission
          </Badge>
        </div>
      </Card>
