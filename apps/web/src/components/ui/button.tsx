...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60 ring-offset-background",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-red-600 via-red-500 to-rose-500 !text-white shadow-lg shadow-red-500/25 hover:shadow-red-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200",
    ...
    const resolvedVariant =
      variant === "primary"
        ...
        : variant === "danger"
          ? "destructive"
          : variant ?? "default";
    const resolvedSize = size === "md" ? "default" : size ?? "default";
    return (
      <Comp
